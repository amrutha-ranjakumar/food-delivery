...
function About() {
  return (
    <div>
      ...
      {/* Cards Section */}
      <div
        className="d-flex mb-5 mt-5 justify-content-center"
        style={{
          overflowX: 'auto',
          gap: '4rem',
        ...
        {[aboutImage, aboutImage1, aboutImage2, aboutImage3, aboutImage4, aboutImage6, aboutImage7].map((image, index) => (
          <Card key={index} style={{ minWidth: '8rem', flex: '0 0 auto' }} className="shadow-lg border-0 text-center">
            ...
            />
            <Card.Body>
              <Card.Title style={{ fontSize: '1rem', fontWeight: 'bold', color: '#333',top:"400px" }}>
      ...
      <Container>
        <Row className="align-items-center justify-content-center mt-5">
          <Card className="shadow-lg border-0" style={{ borderRadius: '20px', overflow: 'hidden', maxWidth: '80%', height: 'auto' }}>
            <Row className="g-0">
              {/* About Text Section */}
              <Col xs={12} md={6} className="p-4" style={{ backgroundColor: '#ff9900' }}>
                ...
                <Button variant="danger" size="lg" className="mt-3" style={{ borderRadius: '25px', padding: '8px 16px', color: '#333300' }}>
                  Order Now
                </Button>
              </Col>
